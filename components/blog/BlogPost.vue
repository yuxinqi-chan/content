...
const config = computed(() => {
  ...
  return {
    ...
    title:
      "text-gray-900 dark:text-white text-xl font-semibold truncate group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-200",
...
const { ui, attrs } = useUI(
  "blog.post",
  toRef(props, "ui") as Ref<Partial<typeof config.value>>,
  config,
  toRef(props, "class"),
  true,
);
