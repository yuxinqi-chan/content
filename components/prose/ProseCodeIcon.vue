...
const hasIcon = computed(
  () =>
    props.icon ||
    (extension.value && ui.value[extension.value as keyof typeof ui.value]) ||
...
const icon = computed(
  () =>
    props.icon ??
    ((props.filename &&
      (ui.value[props.filename.split("/").pop() as keyof typeof ui.value] ??
        ui.value[extension.value as keyof typeof ui.value] ??
...
<template>
  <UIcon :name="icon.split(' ').pop()!" dynamic />
</template>
