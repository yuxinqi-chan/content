...
import type { SortType, PlayModeType, RGB, ColorScheme } from "@/types/player";
...
export const usePlayerStatusStore = defineStore({
  id: "playerStatusStore",
  state: (): StatusState => ({
    // 菜单折叠状态
    menuCollapsed: false,
    // 搜索框状态
